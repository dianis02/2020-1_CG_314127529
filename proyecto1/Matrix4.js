  ...
  class Matrix4 {
	...
	*/
	static frustum(left, right, bottom, top, near, far){
		let matrixO= new Matrix4((2*near)/(right-left),0,0,0,
	...
	*/
	static lookAt(eye, center, up){
		...
		let matrixL= new Matrix4(u.x,v.x,w.x,0,
								 u.y,v.y,w.y,0,
								 u.z,v.z,w.z,0,
								-CG.Vector3.dot(u,eye),-CG.Vector3.dot(v,eye),-CG.Vector3.dot(w,eye),1);
	...
	*/
	static scale(s){
		let matrixS= new Matrix4(s.x,0,0,0,
								 0,s.y,0,0,
								 0,0,s.z,0,
								 0,0,0,1);
		return matrixS;
